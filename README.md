...
![Spotify Clone](https://github.com/vukrosic/next14-spotify-clone/blob/main/public/thumbnail.png?raw=true)
...
## Clone this repo
```bash
git clone https://github.com/vukrosic/next14-spotify-clone
```

## Install packages
```bash
cd next14-spotify-clone & npm install
```
